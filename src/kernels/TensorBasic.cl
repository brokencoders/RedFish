...
void kernel tensor_scalar_add_equal(const float64 B, global float64* C)
{
    C[get_global_id(0)] += B;
}
...
void kernel tensor_tensor_add_equal(constant float64* A, global float64* C)
{
...
void kernel tensor_scalar_sub_equal(const float64 B, global float64* C)
{
    C[get_global_id(0)] -= B;
}
...
void kernel tensor_sub(constant float64* A, global float64* C)
{
    C[get_global_id(0)] = -A[get_global_id(0)];
}
...
void kernel tensor_tensor_sub_equal(constant float64* A, global float64* C)
{
    C[get_global_id(0)] -= A[get_global_id(0)];
}
...
void kernel tensor_scalar_mul_equal(const float64 B, global float64* C)
{
    C[get_global_id(0)] *= B;
}
...
void kernel tensor_tensor_mul_equal(constant float64* A, global float64* C)
{
    C[get_global_id(0)] *= A[get_global_id(0)];
}
...
void kernel tensor_scalar_div_equal(const float64 B, global float64* C)
{
    C[get_global_id(0)] /= B;
}
...
void kernel tensor_tensor_div_equal(constant float64* A, global float64* C)
{
    C[get_global_id(0)] /= A[get_global_id(0)];
}

void kernel tensor_set(global float64* buffer, const float64 value)
{
